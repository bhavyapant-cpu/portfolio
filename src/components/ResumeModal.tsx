    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-dark-900 border border-white/15 rounded-3xl shadow-2xl p-6 sm:p-8 overflow-hidden z-10 my-auto"
        >
          {/* Header */}
          <div className="flex items-center justify-between border-b border-white/10 pb-6 mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white tracking-tight">Bhavya Pant</h2>
                <p className="text-xs font-mono text-slate-400">Software Engineer — Resume Overview</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
              ...
              <div className="text-lg font-bold font-mono text-accent-cyan">1,400+ Devices</div>
            </div>
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
              <div className="text-[10px] font-mono text-slate-400">Throughput</div>
              <div className="text-lg font-bold font-mono text-accent-indigo">200K+ Req/Day</div>
            </div>
          </div>

          {/* Summary Checklist */}
          <div className="space-y-3 mb-6">
            <div className="text-xs font-mono text-slate-400 uppercase tracking-wider">Key Engineering Stack</div>
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-gradient-to-r from-accent-blue via-accent-cyan to-accent-indigo text-dark-950 font-bold text-sm font-mono flex items-center justify-center gap-2.5 hover:scale-[1.01] transition-transform shadow-lg shadow-accent-cyan/20"
          >
