  ...
  return (
    <div className="w-full rounded-2xl bg-dark-950 p-4 sm:p-6 border border-white/10 overflow-hidden relative">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pb-3 sm:pb-4 mb-4 sm:mb-6 border-b border-white/10">
        <div className="flex items-center gap-2 text-[11px] sm:text-xs font-mono text-accent-cyan">
      ...
      <div className="relative min-h-[220px] sm:min-h-[300px] flex items-center justify-center">
        ...
        {/* Node Layout Grid */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6 w-full relative z-10">
          {/* Node 1: WhatsApp Client */}
          <motion.div 
            whileHover={{ scale: 1.03 }}
            className="p-3.5 sm:p-4 rounded-xl bg-white/5 border border-emerald-500/30 text-center space-y-2 backdrop-blur-md shadow-lg"
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 mx-auto rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-400">
          ...
          <motion.div 
            whileHover={{ scale: 1.03 }}
            className="p-3.5 sm:p-4 rounded-xl bg-white/5 border border-cyan-500/30 text-center space-y-2 backdrop-blur-md shadow-lg"
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 mx-auto rounded-xl bg-cyan-500/10 flex items-center justify-center text-cyan-400">
          ...
          <motion.div 
            whileHover={{ scale: 1.03 }}
            className="p-3.5 sm:p-4 rounded-xl bg-white/5 border border-purple-500/30 text-center space-y-2 backdrop-blur-md shadow-lg"
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 mx-auto rounded-xl bg-purple-500/10 flex items-center justify-center text-purple-400">
          ...
          <motion.div 
            whileHover={{ scale: 1.03 }}
            className="p-3.5 sm:p-4 rounded-xl bg-white/5 border border-amber-500/30 text-center space-y-2 backdrop-blur-md shadow-lg"
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 mx-auto rounded-xl bg-amber-500/10 flex items-center justify-center text-amber-400">
      ...
      {/* Legend & Stats */}
      <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1.5 text-[10px] sm:text-[11px] font-mono text-slate-400">
